import { ArrowUpRight, Github, Youtube, Linkedin, MessageSquare, Briefcase, BadgeCheck, Zap, Globe2, Sparkles } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div 
            id="holographic-card"
            className="w-full max-w-sm bg-white/5 backdrop-blur-2xl border border-white/20 p-8 rounded-[2rem] relative flex flex-col items-center text-center shadow-2xl rotate-2 hover:rotate-0 transition-all duration-700 select-none animate-[float_8s_ease-in-out_infinite]"
          >
